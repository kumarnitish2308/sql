-- 48 Marketing campaign
-- 🔗 https://youtu.be/m_oDI0bD6VQ?si=jVBfxfmfio9lQcue
...
/*
You have a table of in-app purchase by user. Users that make their first in-app purchase are placed in a marketing 
campaign where they see call-to-action for more in-app purchase.
Find the users who made additional in-app purchases due to the success of the marketing campaign.

The marketing campaign doesn't start until one day after the initial in-app purchase so users that only 
made one or multiple purchases on the first day do not count, nor do we count users that over time purchases 
the product that they purchased on the first day
*/
